...
Cartographer::Cartographer(
  const NodeOptions& node_options, ::rclcpp::Node::SharedPtr node,
  ...
  :node_options_(node_options)
{
  ...
  tf_buffer_.reset(new tf2_ros::Buffer(node_handle_->get_clock(), ::tf2::durationFromSec(kTfBufferCacheTimeInSeconds)));
